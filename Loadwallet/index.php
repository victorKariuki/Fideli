...
if(isset($_POST['submit'])){
    ...
    $headers = array(
        ...
        'ApiKey: gSjuSyNj3tg' // Replace with your api key
     );
    ...
    <div class="container mt-5 d-flex justify-content-center">
        ...
        <div class="card p-3">
            <div class="d-flex flex-row align-items-center justify-content-between text-white">
                <div class="d-flex flex-row align-items-center"> <i class="fa fa-angle-left"></i> <span> FIDELITY VENTURES LOAD WALLET </span> </div>
            ...
            <div class="px-5"> <input  class=" d-block custom2 form-control mt-3 bg-white " type="text"  name="amount" placeholder="Amount"></div>
