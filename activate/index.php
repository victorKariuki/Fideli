    ...
    <div class="container mt-5 d-flex justify-content-center">
        ...
        <div class="card p-3">
            <div class="d-flex flex-row align-items-center justify-content-between text-white">
                <div class="d-flex flex-row align-items-center"> <i class="fa fa-angle-left"></i> <span class="ml-2">ACTIVATE BY PAYING KES 500 </span> </div>
            ...
            <div class="px-5"> <span class="button mt-3 d-block bg-white p-2">KSH 500.00</span> </div>
            <br>
