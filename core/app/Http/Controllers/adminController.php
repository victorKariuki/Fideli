...
class adminController extends Controller
{
  ...
  public function updateuser(Request $req){
     ...
     $amount = $req -> amount;
      ...
      if(!$user){
          Session::put('status', "user with that number is not found");
           return back()->withErrors(['msg' => 'user with this phone not found']);
      }elseif($user){
          $bal=$user->wallet;
          $up = $bal + $amount;
           ...
           DB::table('users')
              ...
              return back()->withErrors(['msg' => 'Deposit was successfull']);
      }
      //update balance
  }
