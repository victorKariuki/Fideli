...
?>
										...
										<div class="d-flex">
											<div class="mr-5">
												<div class="ecommerce-icon">
													<img src="{{url('core/public/assets/images/png/wallet.png')}}" alt="img">
												</div>
											</div>
											<div class="text-white mt-3">
												<p class="mb-1 font-weight-semibold fs-14"> WALLET </p>
												<h2 class="mt-1 mb-0 fs-30 font-weight-bold ">{{$settings->currency}} {{ number_format($user->wallet, 2) }}</h2>
											</div>
										</div>
									</div>
								...
								<div class="card bg-gradient-success img-card overflow-hidden">
									<div class="card-body">
										<div class="d-flex">
											<div class="mr-5">
												<div class="ecommerce-icon">
													<img src="{{url('core/public/assets/images/png/cart.png')}}" alt="img">
												</div>
											</div>
											<div class="text-white mt-3">
												<p class="mb-1 font-weight-semibold fs-14"> EARNINGS </p>
												<h2 class="mt-1 mb-0 fs-30 font-weight-bold ">{{$settings->currency}} {{ number_format($currentEarning, 2) }}</h2>
											</div>
										</div>
									</div>
									<img src="{{url('core/public/assets/images/png/circle.png')}}" alt="img" class="img-card-circle">
								...
								<div class="card bg-gradient-danger img-card overflow-hidden">
									<div class="card-body">
										<div class="d-flex">
											<div class="mr-5">
												<div class="ecommerce-icon">
													<img src="{{url('core/public/assets//images/png/location.png')}}" alt="img">
												</div>
											</div>
											<div class="text-white mt-3">
												<p class="mb-1 font-weight-semibold fs-14"> REFERRAL BONUS </p>
												<h2 class="mt-1 mb-0 fs-30 font-weight-bold ">{{$settings->currency}} {{ number_format($user->ref_bal, 2) }}</h2>
											</div>
										</div>
									</div>
									<img src="{{url('core/public/assets/images/png/circle.png')}}" alt="img" class="img-card-circle">
								...
								<div class="card bg-gradient-info img-card overflow-hidden">
									<div class="card-body">
										<div class="d-flex">
											<div class="mr-5">
												<div class="ecommerce-icon">
													<img src="{{url('core/public/assets/images/png/gift.png')}}" alt="img">
												</div>
											</div>
											<div class="text-white mt-3">
       ...
       <!--         <div class="row">-->
							...
							<!--	<div class="card">-->
							<!--	       <div>-->
							<!--				<h3 class="card-title"> {{ __('Referral link:') }}:: </h3>-->
							<!--			</div>-->
       <!--                                     <div class="card-options">-->
       <!--                                    <a href="/register/{{$user->username}}" class="text-info" id="reflnk" >-->
								...
								<div class="card  bg-gradient-secondary">
									...
									<div class="card-body">
										<div class="table-responsive">
										 <a href="https://Fidelityventures.top/register/{{$user->username}}" onclick="copyURI(event)" class="btn btn-info" id="reflnk" >
                                                <!--<small>{{env('APP_URL').__('/register/').$user->username}}</small>-->
                                                Copy Link
                                            </a>  
