...
// ****************************vaultcoin *******************************************//
Route::post('/user/coin/buy', 'Offerscontroller@buyCoin')->middleware('auth');
Route::post('/user/coin/sellus', 'Offerscontroller@sellCoin')->middleware('auth');
Route::post('/user/coin/peer', 'Offerscontroller@peer')->middleware('auth');
Route::post('/user/kopa/pesa', 'Offerscontroller@kopa')->middleware('auth');
//+++++++++++++++++++++++++++++end+++++++++++++++++++++++++++++++++++++++++++++//
...
Route::post('/admin/home', 'adminController@updateuser' );
