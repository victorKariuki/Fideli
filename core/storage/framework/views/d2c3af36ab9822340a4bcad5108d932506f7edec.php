                                ...
                                <div class="card-header">
                                    <div class="card-head-row">
                                        <div class="card-title col-sm-12"  ><?php echo e(__('Open Ticket')); ?> 
                                            <span class="float-right"><a data-target="#open_ticket" data-toggle="modal" href="javascript:void(0)" class="btn btn_primary bg-info text-black"><i class="fas fa-plus-circle "></i>New Ticket</a></span>
                                        </div>
                                    </div>
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/everbeei/Fidelityventures.top/core/resources/views/user/ticket.blade.php ENDPATH**/ ?>