										...
										<div class="row">
											<div class="col-xl-12">
											   ...
											   <?php $user=Auth::user();?>
													...
													<input type="text" class="form-control" value="<?php echo $user->ref_bal;?>" readonly>
												</div>
												<div class="form-group">
										...
										<div class="row">
											<div class="col-xl-12">
											   ...
											   <?php $user=Auth::user();?>
											        ...
											        <div class="form-group">
													<input type="text" class="form-control" value=" <?php echo $user->wallet;?>" readonly>
												</div>
												<div class="form-group">
													<input type="text" class="form-control" name="amt" placeholder="Amount">
												</div>
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/candlest/tru.candlesticktrade.xyz/core/resources/views/user/withdrawal.blade.php ENDPATH**/ ?>