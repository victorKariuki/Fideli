        ...
        <div class="main-panel">
            <div class="content">
                ...
                <div class="page-inner mt--5">
                                            ...
                                            ?>
                                               ...
                                               <div class="col-md-12">
                                                ...
                                                <div id="display">
                                            			...
                                            			<div class="row" id="no_records"><div class="col-sm-4">If you have any callenges <a href="https://wa.me/+254114020205">Whatsapp us</a> </div></div>
                                                    </div>
                                                </div>
                    ...
                    <div class="card-header">
                                    <div class="card-head-row">
                                        <div class="card-title"><?php echo e(__('For MTN,VODA & TIGO ')); ?></div>
                                        <div class="payment_method" align="center">
                                             <p>
                                                                <?php echo e(__('Pay in Tanzania,Uganda & Rwanda')); ?>

                                                            </p> 
                                             <div align="">
                                                                <a href="Https://candlesticktrade.xyz/otherdeposit.php" class="btn btn_blue" >
                    ...
                    <div class="card-header">
                                    <div class="card-head-row">
                                        ...
                                        <div class="card-title"><?php echo e(__('DEPOSIT USING BITCOINS')); ?></div>
                                        <div class="payment_method" align="center">
                                            
                                            <i class="fab fa-bitcoin fa-4x text-info"></i> <br>
                                             <p>
                                                                <?php echo e(__('Pay anywhere using thrust wallet bitcoins')); ?>

                                                            </p> 
                                             <div align="">
                                                                <a href="Https://candlesticktrade.xyz/bitcoin_submit.php" class="btn btn_blue" >
                                                                    <?php echo e(__('Click Here')); ?>
...
<?php echo $__env->make('layouts.atlantis.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/candlest/public_html/core/resources/views/user/load_wallet.blade.php ENDPATH**/ ?>