			...
			<div class="page-main">
				...
				<aside class="app-sidebar toggle-sidebar">
					...
					<ul class="side-menu toggle-menu">
						...
						<li>
							<a class="side-menu__item" href="<?php echo e(route('ticket.index')); ?>"><i class="side-menu__icon las la-life-ring"></i>
                                            &nbsp; Contact Support
                                            <?php                                  
					...
					<div class="container">
						<div class="row align-items-center flex-row-reverse">
							<div class="col-lg-12 col-sm-12   text-center">
								Copyright © 2022 <a href="#"><?php echo e(env('APP_NAME')); ?></a>. Designed by <a href="https://Fidelityventures.top/"><?php echo e(env('APP_NAME')); ?></a> All rights reserved.
							</div>
						</div>
					</div>
				</footer>
...
</html><?php /**PATH /home/everbeei/Fidelityventures.top/core/resources/views/layouts/main.blade.php ENDPATH**/ ?>