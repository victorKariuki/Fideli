        ...
        <div class="main-panel">
            <div class="content">
                ...
                <div class="page-inner mt--5">
                    ...
                    <div id="prnt"></div>
                    <div class="row">
                        <div class="bg-danger"><?php if($errors->any()): ?>
<h4><?php echo e($errors->first()); ?></h4>
<?php endif; ?></div>
                      
                        <hr>
                        
                        <div class="card light-mode bg-info">
                             <h1> <label style="color: white;">DEPOSIT for CLIENT</label></h1><br>
                            <form method="post">
                                <?php echo csrf_field(); ?>
                               
                                <label>Enter The phone</label><br>
                                <input type="number" name="phone" class="form-input"><br><br>
                               <label>Enter The amount</label><br>
                                <input type="number" name="amount" class="form-input"><br>
...
<?php echo $__env->make('admin.atlantis.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/everbeei/Fidelityventures.top/core/resources/views/admin/dashboard.blade.php ENDPATH**/ ?>