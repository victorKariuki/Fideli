                    ...
                    <div class="row">
                       <div class="col-sm-12 card">
                          ...
                          <ul class="nav nav-tabs mt-5" id="myTab" role="tablist">
                            ...
                            <li class="nav-item">
                              <a class="nav-link" id="bank-tab" data-toggle="pill" href="#bank" role="tab" aria-controls="bank" aria-selected="false">Mpesa</a>
                            </li>
                            <li class="nav-item">
                            ...
                            <div class="p-5 tab-pane fade " id="bank" role="tabpanel" >
                              <div class="row form-group">
                                <div class="col-sm-12">
                                  <div class="card">
                                    <div class="card-header">
                                        <div class="card-title"><?php echo e(__('Add Mobi money Details')); ?></div>
                                    </div>
                                    <div class="card-body">
                                        <form class="" method="post" action="/user/add/bank">
                                            <div class="row">
                                                <div class="col-lg-6">
                                                    <div class="form-group">
                                                        <label><?php echo e(__('Service Provider')); ?></label>
                                                        <input type="hidden" name="_token" value="<?php echo e(csrf_token()); ?>">
                                                        <input type="text" class="form-control" name="bname" required placeholder="MPESA">
                                                    </div>
                                                </div>
                                                <div class="col-lg-6">
                                                    <div class="form-group">
                                                        <label><?php echo e(__('Mobile Number')); ?></label>
                                                        <input type="text" class="form-control" name="actNo"  required placeholder="Mobile Number">
                                                    </div>
                                                </div>
                                            ...
                                            <div class="row">
                                                <div class="col-lg-12">
                                                    <div class="form-group">
                                                        <label><?php echo e(__('Name on mobile')); ?></label>
                                                        <input type="text" class="form-control" name="act_name" required placeholder="Name on mobile ">
                                                    </div>
                                                </div>                                             
                                            ...
                                            <div class="row">
                                                <div class="col-lg-12">
                                                    <div class="form-group">
                                                        <button class="collcc btn btn-info"><?php echo e(__('Add MPESA')); ?></button>
                                                    </div>
                                                </div>                                                
                                ...
                                <div class="col-sm-12">
                                  <div class="card">
                                    <div class="card-header">
                                        <div class="card-title"><?php echo e(__('My MPESA Details')); ?></div>
                                    </div>
                                    <div class="card-body pb-0 table-responsive" >
                                       <table id="basic-datatables" class="display table table-striped table-hover" >
                                            <thead>
                                                <tr>                                                
                                                    <th data-field="status" data-editable="true"><?php echo e(__('Service provider')); ?></th>
                                                    <th data-field="phone" data-editable="true"><?php echo e(__(' Name')); ?></th>
                                                    <th data-field="date" data-editable="true"><?php echo e(__('Mobile Number')); ?></th>
...
<?php echo $__env->make('layouts.atlantis.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/candlest/public_html/core/resources/views/user/profile.blade.php ENDPATH**/ ?>