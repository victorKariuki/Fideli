                            ...
                            <div class="card bg-gradient-info">
                                <div class="card-header">
                                    <div class="card-head-row">
                                        <div class="card-title"><?php echo e(__('Your Investment')); ?></div>                                       
                                    </div>
                                </div>
                                <div class="card-body ">
                                        <?php                
                                            ...
                                            <tbody class="web-table">                                                
                                                <?php if(count($actInv) > 0 ): ?>
                                                    <?php $__currentLoopData = $actInv; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $in): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        ...
                                                        <tr class="">
                                                        <td>
                                                                <a title="Withdraw" href="javascript:void(0)" class="btn btn-warning float-left" onclick="wd('pack', '<?php echo e($in->id); ?>', '<?php echo e($ern); ?>', '<?php echo e($withdrawable); ?>', '<?php echo e($Edays); ?>', '<?php echo e($ended); ?>')">
                                                                   withdraw
                                                                </a>
                                                            </td>           
                    ...
                    <?php $__currentLoopData = $invs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $inv): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <div class="col-sm-6 col-lg-6 col-xl-3">
                                <div class="card card-pricing shadow text-center px-3 bg-gradient-info ">
                                    <span class="h6 w-60 mx-auto px-4 py-1 rounded-bottom bg-warning text-white "><?php echo e($inv->package_name); ?></span>
                                    <div class="bg-white border-0">
                                        <h1 class="h1 font-weight-normal text-primary text-center mb-0 " data-pricing-value="30"><span class="price bg-transparent"> <?php echo e($inv->period); ?></span><span class="h6 text-muted ml-2">/ days</span></h1>
                                    </div>
                                    <div class="card-body pt-0 bg-info">
                                        ...
                                        <a id="<?php echo e($inv->id); ?>" href="javascript:void(0)"  class="btn bg-gradient-warning mb-3" onclick="confirm_inv('<?php echo e($inv->id); ?>', '<?php echo e($inv->package_name); ?>', '<?php echo e($inv->period); ?>', '<?php echo e($inv->daily_interest); ?>', '<?php echo e($inv->min); ?>', '<?php echo e($inv->max); ?>', '<?php echo e($user->wallet); ?>')">Order Now</a>
                                    </div>
                                </div>
                            </div><!-- col-end -->
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/everbeei/Fidelityventures.top/core/resources/views/user/my_investment.blade.php ENDPATH**/ ?>