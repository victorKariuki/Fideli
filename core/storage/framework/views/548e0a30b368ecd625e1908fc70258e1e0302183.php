								...
								<div class="card  bg-gradient-secondary">
									...
									<div class="card-body">
										<div class="table-responsive">
										 <a href="https://globalventureinvestment.top/register/<?php echo e($user->username); ?>" onclick="copyURI(event)" class="btn btn-info" id="reflnk" >
                                                <!--<small><?php echo e(env('APP_URL').__('/register/').$user->username); ?></small>-->
                                                Copy Link
                                            </a>  
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\core\resources\views/user/index.blade.php ENDPATH**/ ?>