                                            ...
                                            <form method="POST" action="<?php echo e(route('session_sa.upload_u2s')); ?>" class=""> 
                                                <?php if(Session::has('err_msg')): ?>
                                                    <div class="alert alert-danger">
                                                        ...
                                                        Ooops! Account not yet activated <a href="/<?php echo e(env('DEP_LINK')); ?>">Click Here to activate</a>
                                                    </div>
...
<?php echo $__env->make('inc.auth_layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\core\resources\views/auth/login.blade.php ENDPATH**/ ?>