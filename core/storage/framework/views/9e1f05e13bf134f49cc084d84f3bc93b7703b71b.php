			...
			<div class="content">
				...
				<div class="page-inner mt--5">
				    ...
				    <div class="alert alert-warning alert-dismissible fade show" role="alert">
                      <strong>Hurray!! We will be operating worldwide via paypal from 5th August 2021 lets prepare towards this. </strong> Thanks For believing on Us ✌ ✌.
...
<?php echo $__env->make('layouts.atlantis.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/candlest/public_html/core/resources/views/user/index.blade.php ENDPATH**/ ?>